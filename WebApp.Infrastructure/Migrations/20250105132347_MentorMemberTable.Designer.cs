...
namespace WebApp.Infrastructure.Migrations
{
    ...
    [Migration("20250105132347_MentorMemberTable")]
    partial class MentorMemberTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Core.Domain.Entities.MemberMentor", b =>
                {
                    b.Property<string>("MentorLoginName")
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("MemberLoginName")
                        .HasColumnType("nvarchar(50)");

                    b.HasKey("MentorLoginName", "MemberLoginName");

                    b.HasIndex("MemberLoginName");

                    b.ToTable("MemberMentors");
                });
            ...
            modelBuilder.Entity("WebApp.Core.Domain.Entities.MemberMentor", b =>
                {
                    ...
                    b.HasOne("WebApp.Core.Domain.Entities.Member", "Mentor")
                        .WithMany("Mentoring")
                        .HasForeignKey("MentorLoginName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
