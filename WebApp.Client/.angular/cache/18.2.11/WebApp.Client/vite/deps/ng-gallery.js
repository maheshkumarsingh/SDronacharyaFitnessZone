...
import {
  DomSanitizer
} from "./chunk-XSTWOQ43.js";
import "./chunk-IIJIENZZ.js";
import {
  AsyncPipe,
  CommonModule,
  DOCUMENT,
...
var SmoothScroll = class _SmoothScroll {
  ...
  scrollTo(params) {
    ...
    if (isRtl && rtlScrollAxisType2 !== RtlScrollAxisType.NORMAL) {
      if (options.left != null) {
        options.right = this._el.scrollWidth - this._el.clientWidth - options.left;
      }
      if (rtlScrollAxisType2 === RtlScrollAxisType.INVERTED) {
        options.left = options.right;
      } else if (rtlScrollAxisType2 === RtlScrollAxisType.NEGATED) {
