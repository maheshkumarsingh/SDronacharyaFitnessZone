...
var PagerComponent = class _PagerComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      standalone: true,
      features: [ɵɵProvidersFeature([PAGER_CONTROL_VALUE_ACCESSOR]), ɵɵStandaloneFeature],
      decls: 7,
      vars: 24,
...
var PaginationComponent = class _PaginationComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      standalone: true,
      features: [ɵɵProvidersFeature([PAGINATION_CONTROL_VALUE_ACCESSOR]), ɵɵStandaloneFeature],
      decls: 16,
      vars: 6,
